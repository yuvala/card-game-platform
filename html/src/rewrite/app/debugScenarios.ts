...
export interface RewriteDebugScenario {
    id: string;
    label: string;
    description: string;
...
export const rewriteDebugScenarios: readonly RewriteDebugScenario[] = [
    {
...
export function getRewriteDebugScenarioById(id: string | null | undefined): RewriteDebugScenario | null {
    if (!id) {
        return null;
    }

    return rewriteDebugScenarios.find((scenario) => scenario.id === id) ?? null;
}
