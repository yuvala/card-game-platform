...
export class UIScene<TSnapshot> extends Phaser.Scene {
    ...
    create(): void {
        ...
        this.add
            .text(HUD_X + 34, 40, 'TABLE CONTROLS', {
        ...
        this.add
            .text(
                HUD_X + 34,
                252,
                'Use the Create Game drawer to change the ruleset, seats, or deck.',
                {
                    fontFamily: TABLE_FONT_FAMILY,
                    fontSize: '15px',
        ...
        this.outcomeTitleText = this.add
            .text(HUD_X + 34, 348, '', {
                fontFamily: TABLE_FONT_FAMILY,
                fontSize: '18px',
                color: '#ffd166',
            ...
            .setResolution(UI_TEXT_RESOLUTION)
            .setVisible(false);
        this.outcomeDetailText = this.add
            .text(HUD_X + 34, 376, '', {
                fontFamily: TABLE_FONT_FAMILY,
                fontSize: '14px',
        ...
        this.add
            .rectangle(HUD_X + HUD_WIDTH / 2, 620, HUD_WIDTH - 68, 118, 0x10221b, 0.84)
            .setStrokeStyle(2, TABLE_GOLD, 0.18);
        this.add
            .text(HUD_X + 34, 550, 'STATUS', {
                fontFamily: TABLE_FONT_FAMILY,
                fontSize: '13px',
                color: '#ffd166',
                letterSpacing: 2,
    ...
    private syncOutcome(viewModel: CardGameViewModel): void {
        ...
        this.outcomeTitleText.setText(outcome.title).setVisible(true);
        this.outcomeDetailText.setText(outcome.detail).setVisible(true);
    ...
    private syncPrimaryAction(viewModel: CardGameViewModel): void {
        ...
        this.actionHintText.setText(action.hint).setVisible(Boolean(action.hint));
    }
    ...
    private setButtonState(button: Phaser.GameObjects.Text, isEnabled: boolean): void {
        ...
        button.setBackgroundColor(
            isEnabled ? '#f7d46c' : '#' + TABLE_GOLD_DARK.toString(16).padStart(6, '0'),
        );
        if (isEnabled) {
